$(function(){
		...
		if ($(window).width()<=1024) {
			$('video.reel').removeAttr('autoplay');
			var controller = new ScrollMagic.Controller();

				var scene6 = new ScrollMagic.Scene({
					triggerElement: "#scene-two",triggerHook: 'onLeave', duration: 1550,
					offset: -10
				})
				.setPin("#scene-two")
				.addTo(controller);
				...
				var scene15 = new ScrollMagic.Scene({
					triggerElement: "#scene-three",triggerHook: 'onLeave', duration: 3030,
					offset: -10
				})
				.setPin("#scene-three")
				...
				var scene26 = new ScrollMagic.Scene({
					triggerElement: "#scene-four",triggerHook: 'onLeave', duration: 1695,
					offset: -10
				})
				.setPin("#scene-four")
				...
				var scene33 = new ScrollMagic.Scene({
					triggerElement: "#scene-five",triggerHook: 'onLeave', duration: 1140,
					offset: -10
				})
				.setPin("#scene-five")
				.addTo(controller);
...
$(window).load(function(){
	if ($(window).width()>=1024) {
		...
		// $('#odometer1').removeClass('odometer');
		odometer1.innerHTML = 1095;
	}
...
function mobileSliderOne() {
	var left = $('.statistic-one-wrapper .statistic-one .mobile-arrow-left'),
	right = $('.statistic-one-wrapper .statistic-one .mobile-arrow-right'),
	cur = 1;
	...
	left.click(function(){
		if (cur==1) {
			...
			$('.statistic-one-wrapper .statistic-one .donuts-wrapper div[data="'+cur+'"]').css('opacity','0');
			cur--
			$('.statistic-one-wrapper .statistic-one .donuts-wrapper div[data="'+cur+'"]').css('opacity','1');
			console.log(cur);
		}
	});
...
function mobileSliderTwo() {
	var left = $('.statistic-one-slider .mobile-arrow-left'),
	right = $('.statistic-one-slider .mobile-arrow-right'),
	obj = $('.statistic-one-wrapper .statistic-mob'),
	...
	left.click(function(){
		if ($(this).hasClass('unactive')) {
			...
			if ((curLeft-windowWidth)>0) {
				curLeft = curLeft - windowWidth;
				obj.animate({left: -curLeft},600);
				right.removeClass('unactive');
			} else if ((curLeft-windowWidth) <= 0) {
				curLeft = 0;
				obj.animate({left: curLeft},600);
	...
	right.click(function(){
		if ($(this).hasClass('unactive')) {
			...
			if ((curWidth+windowWidth)<maxWidth) {
				curWidth = curWidth+windowWidth;
				curLeft = curLeft + windowWidth;
				obj.animate({left: -curLeft},600);
				left.removeClass('unactive');
			} else if ((curWidth+windowWidth) === maxWidth) {
				curWidth = windowWidth;
				curLeft = curLeft + windowWidth;				
				obj.animate({left: -curLeft},600);
				left.removeClass('unactive');
...
function mobileSliderThree() {
	var left = $('.statistic-two-wrapper .statistic-two .mobile-arrow-left'),
	right = $('.statistic-two-wrapper .statistic-two .mobile-arrow-right'),
	cur = 1;
	...
	left.click(function(){
		if (cur==1) {
			...
			$('.statistic-two-wrapper .statistic-two .donuts-wrapper div[data="'+cur+'"]').css('opacity','0');
			cur--
			$('.statistic-two-wrapper .statistic-two .donuts-wrapper div[data="'+cur+'"]').css('opacity','1');
			console.log(cur);
		}
	});
...
function mobileSliderFour() {
	var left = $('.statistic-three-wrapper .statistic-three .mobile-arrow-left'),
	right = $('.statistic-three-wrapper .statistic-three .mobile-arrow-right'),
	cur = 1;
	...
	left.click(function(){
		if (cur==1) {
			...
			$('.statistic-three-wrapper .statistic-three .authors-wrap a[data="'+cur+'"]').css('opacity','0');
			cur--
			$('.statistic-three-wrapper .statistic-three .authors-wrap a[data="'+cur+'"]').css('opacity','1');
			console.log(cur);
		}
	});
...
function mobileSliderFive() {
	var left = $('.statistic-three-wrapper .statistic-three .mobile-arrow-left-v2'),
	right = $('.statistic-three-wrapper .statistic-three .mobile-arrow-right-v2'),
	cur = 1;
	...
	left.click(function(){
		if (cur==1) {
			...
			$('.statistic-three-wrapper .statistic-three .donuts-wrapper div[data="'+cur+'"]').css('opacity','0');
			$('.statistic-three-wrapper .statistic-three table[data="'+cur+'"]').css('opacity','0');
			cur--
			$('.statistic-three-wrapper .statistic-three .donuts-wrapper div[data="'+cur+'"]').css('opacity','1');
			$('.statistic-three-wrapper .statistic-three table[data="'+cur+'"]').css('opacity','1');
			console.log(cur);
		}
	});
